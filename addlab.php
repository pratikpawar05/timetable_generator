...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Subject </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> <li class="active">Lab</li>
  ...
  <form id="formval" action="" method="post">
                 ...
                 <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" placeholder="" name="lab" id="lab" onblur="" >
                ...
                <a href="">   <button class="btn btn-success" type="submit" name="addlab" id="addlab"  ><i class="fa fa-fw fa-lg fa-check-circle" ></i>Add Lab</button></a>
               </div>
             </div>
           </form>
...
if(isset($_POST['addlab']))
{
 ...
 $query=mysqli_query($connection,"INSERT INTO lab (lab) VALUES('$lab')");
   if($query)
    {

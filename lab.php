...
<h3 class="tittle-w3-agileits mb-4" style="font: italic;">List of Lab</h3>
                ...
                <a href='addlab.php' class="btn btn-success" style="float: right;" >Add Lab</a><br><br><br>
    ...
    while($row = mysqli_fetch_array($query)){ 
        ...
        ?>
                            ...
                            <tr>
                                ...
                                <td><a href='deletelab.php?srno=<?php echo $row['srno']; ?>' class="btn btn-danger">Delete</a></td>

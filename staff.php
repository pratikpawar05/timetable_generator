      ...
      <div class="content-wrapper">
        ...
        <table class="table" style="background-color:#3c8dbc; " border="5">
          ...
          <tbody>
            ...
            $query = mysqli_query($connection, "SELECT staffs.id,staffs.name,email_id,mobile_no,dept_name FROM staffs inner join departments on departments.id=staffs.dept_id");
            $n = 1;
            if ($query) {
